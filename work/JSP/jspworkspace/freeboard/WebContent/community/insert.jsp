...
<form name="frm1" method="post" action="insertAction.jsp">
 ...
 <table>
 	<tr><td width="25%" class="td1">제목</td>
 		<td><input type="text" name="subject" size="70" class="input1" required="required"></td>
 	</tr>
 	<tr><td class="td1">작성자</td>
 		<td><input type="text" name="name" size="70" class="input1" required="required"></td>
 	</tr>
 	
 	<tr><td class="td1">글 비밀번호</td>
 		<td><input type="password" name="password" size="70" class="input1" required="required"></td>
 	</tr>
 	<tr><td class="td1">내용</td>  <!-- textarea 의 크기 : rows="20" cols="80" -->
 		<td><textarea  rows="20" cols="80" name="content" class="input1" required="required"></textarea></td>
 	</tr>
